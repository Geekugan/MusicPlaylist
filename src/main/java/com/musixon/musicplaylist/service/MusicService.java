...
import com.musixon.musicplaylist.exception.MusicNotFoundException;
...
music.setMusicCode(UUID.randomUUID().toString());
   return musicRepo.save(music);}
    ...
    return musicRepo.findEmployeeById(id).orElseThrow(()->new MusicNotFoundException("Music by id " + id + "was not found"));
